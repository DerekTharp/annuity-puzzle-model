...
# ============================================================
# This Monte Carlo permutation-based Shapley estimator was an earlier
# decomposition tool. It has been replaced by the exact full enumeration
# in run_subset_enumeration.jl, which computes Shapley values exactly
# without permutation noise. The current channel set also bundles
# Medical+R-S into a single channel, eliminating the special-case coupling
# logic this script implemented.
#
...
# permutations. Monte Carlo approximation with N_PERM random permutations
# is used in place of exhaustive enumeration.
#
# Channels:
