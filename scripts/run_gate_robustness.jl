...
open(tex_path, "w") do io
    ...
    println(io, raw"frozen before the cut. The induced response is concentrated in the top band, and zero or negative")
    println(io, raw"below it, across every treatment.")
