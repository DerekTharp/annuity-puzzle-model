...
\item \textbf{Inflation rate:} $\pi \sim U(0.015, 0.025)$. This spans near-term CPI uncertainty around the baseline calibration of 2\%.

\item \textbf{Money's worth ratio:} $\text{MWR} \sim U(0.80, 0.86)$. This reflects measurement uncertainty in current annuity pricing estimates from \citet{mitchell1999} and \citet{wettstein2021}, centered near the baseline of 0.82.
\end{itemize}
...
The median implied $\gamma$ of 2.1 is within the \citet{chetty2006} range of 1--3. The interquartile range [2.02, 2.22] indicates that matching the observed 3.6\% rate with the seven-channel model requires $\gamma$ in a narrow but empirically plausible range regardless of the values of other parameters. All 300 draws converge. Note that these results were computed for the seven-channel model (without age-varying needs and state-dependent utility); the nine-channel model predicts \ownNineChannel{} at $\gamma = \pGamma$ without requiring downward adjustment of risk aversion.
