...
The production calibration sets $\psi_{\text{purchase}} = \pPsiPurchase$ via single-moment SMM on the rational-corrected behavioral elasticity from the UK 2015 pension freedoms reform (60 pp drop, midpoint of the 55--65 pp range; \citealp{abi2020}). This appendix reports four alternative single-moment SMM specifications and the corresponding production-model US ownership predictions. Across alternative anchors the implied $\psi_{\text{purchase}}$ falls in $[0.014, 0.028]$ and the implied US ownership prediction in $[2.2\%, 22.2\%]$, bracketing the observed HRS rate of \pctHRSObserved{} from above and below.
